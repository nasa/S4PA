...
<!-- $Id: S4paGran2CMR.xsl,v 1.7 2020/05/27 15:24:03 s4pa Exp $ -->
<!-- -@@@ S4PA, Version $Name:  $ -->
<xsl:stylesheet
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- This is an XSLT style sheet that transforms S4PA granule metadata
       to CMR Granule metadata, using the CMR schema.
  -->
  <xsl:template match="/">
        ...
        <Granules>
          <Granule>
            ...
            <DataGranule>
              ...
              <xsl:choose>
                <xsl:when test="contains(DataGranule/DayNightFlag,'NA')">
           ...
           <xsl:choose>
            ...
            <!-- Comenting out MeasureParameters because it is marked as deprecated
                 in CMR and will be moving to UMM-Variable. 2018-02-01
            ...
            <!-- s4pa_publish_cmr.pl will replace OnlineAccessURLs
                 with a value -->
            <OnlineAccessURLs/>
            ...
            <!-- Commenting out DataFormat because it is not required
                 by the CMR schema, and because there is not necessarily
                 agreement between the values found in the granule metadata
                 and the values in the collection metadata (determined by
                 the DIF).
